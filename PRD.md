...
|--------|--------|-----------|
| v2.8721332 | `8721332` | feat: botão compra min-height 44px mobile + busca destacada na HOME |
...
| v2.08daf4d | `08daf4d` | fix: loading screen — CSS no head, HTML no início do body, JS no final |
